...
// */
//public class ProductIdDictOld extends KFrontDict<Integer> {
//    /**
//     * @param dictFile            the dictionary file
//     * @param concatenatedStrFile the concatenated string file
//     * @param invertedIdxFile     the inverted index file
//     */
//    public ProductIdDictOld(File dictFile, File concatenatedStrFile, File invertedIdxFile) {
...
//            TextEntry<Integer> entry = dict.get(token);
